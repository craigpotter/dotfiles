...
If you found this repo useful, [consider sponsoring Dries](https://github.com/sponsors/driesvints) (a little bit)! ❤️ 
...
2. [Generate a new public and private SSH key](https://docs.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) by running:
   ...
   ```zsh
   curl https://raw.githubusercontent.com/craigpotter/dotfiles/HEAD/ssh.sh | sh -s "<your-email-address>"
   ```

3. Clone this repo to `~/.dotfiles` with:

    ```zsh
    git clone --recursive git@github.com:craigpotter/dotfiles.git ~/.dotfiles
    ```
